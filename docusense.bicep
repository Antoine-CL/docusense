...
var stgName = 'docusensest${suffix}'
var funcName = 'docusensefunc${suffix}'
var apiName = 'docusenseapi${suffix}'
var swebName = 'docusenseswa${suffix}'
var kvName = 'docusensekv${suffix}'
var searchName = 'docusensesearch${suffix}'
var serviceBusName = 'docusensesb${suffix}'
...
resource funcPlan 'Microsoft.Web/serverfarms@2022-09-01' = {
  name: 'docusense-func-plan-${suffix}'
  location: location
  sku: {
    name: funcSku
...
resource apiPlan 'Microsoft.Web/serverfarms@2022-09-01' = {
  name: 'docusense-api-plan-${suffix}'
  location: location
  sku: {
  ...
  properties: {
    ...
    siteConfig: {
      ...
      appSettings: [
        ...
        { name: 'WEBHOOK_CLIENT_STATE', value: 'docusense-webhook-secret-${suffix}' }
